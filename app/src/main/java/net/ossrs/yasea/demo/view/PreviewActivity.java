...
import net.ossrs.yasea.demo.util.camera.CameraHelper;
import net.ossrs.yasea.demo.util.camera.CameraListener;
...
public class PreviewActivity extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void initEngine() {
        ...
        if (afCode != ErrorInfo.MOK) {
            Toast.makeText(this, "激活失败" + afCode, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == ACTION_REQUEST_PERMISSIONS) {
            ...
            if (isAllGranted) {
                ...
                Toast.makeText(this.getApplicationContext(), "权限不足", Toast.LENGTH_SHORT).show();
            }
        }
    }
