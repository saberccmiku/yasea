...
public class SrsEncoder {
    ...
    public SrsEncoder(SrsEncodeHandler handler,Handler faceHandler) {
        mHandler = handler;
        ...
        if (videoFrameCacheNumber != null && videoFrameCacheNumber.get() < VGOP) {
            ...
            if (useSoftEncoder) {
                ...
                if (processedData != null) {
                    ...
                    message.what = 1;
                    message.obj = RGBAToNV21(data, width, height, false, 180);
    ...
    private native byte[] RGBAToNV21(byte[] frame, int width, int height, boolean flip, int rotate);
